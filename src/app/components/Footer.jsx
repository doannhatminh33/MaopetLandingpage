...
// Separate client component for copyright
const Copyright = () => {
  ...
  return (
    <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400 text-sm">
      <p>&copy; {year} MaoPet. Tất cả quyền được bảo lưu.</p>
    </div>
  );
};
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-400 text-sm">
                Chuyên cung cấp các sản phẩm chất lượng cao cho thú cưng của bạn.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li className="flex items-center gap-2">
                  ...
                  <span>7 ngõ 951 Đường Giải Phóng, Hoàng Mai, Hà Nội</span>
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
